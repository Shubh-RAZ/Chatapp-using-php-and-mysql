<?php
    ...
    if(isset($_POST['sign_in'])){
        ...
        if($check_user==1){
            ...
            $update_msg = mysqli_query( $con , "UPDATE users SET current_status='online' WHERE user_email='$email' " );
            ...
            echo "<script>window.open('navbar.php?user_name=$user_name' , '_self')</script>";
